...
class LocationTypesControllerTest < ActionController::TestCase
  ...
  test "should create location_type" do
    assert_difference('LocationType.count') do
      post :create, location_type: { location_type: @location_type.location_type, location_type_description: @location_type.location_type_description }
    end
  ...
  test "should update location_type" do
    put :update, id: @location_type, location_type: { location_type: @location_type.location_type, location_type_description: @location_type.location_type_description }
    assert_redirected_to location_type_path(assigns(:location_type))
  end
